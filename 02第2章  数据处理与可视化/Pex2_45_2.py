...
Class_Percent = Class_Counts / Class_Counts._sum()
...
# 统计2012年每月销售额
Month_Sales = a[a.year == 2012].groupby(by='month').aggregate({'Sales': np._sum})
# 下面使用Pandas画图
